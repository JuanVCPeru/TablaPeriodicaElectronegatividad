...
# Diccionario de electronegatividades de algunos elementos
...
# Tabla periódica con los valores de electronegatividad
def crear_tabla_periodica():
    datos = {
        'Elemento': list(electronegatividades.keys()),
        'Electronegatividad': list(electronegatividades.values())
    }
...
st.write("### Tabla periódica de electronegatividades")
st.dataframe(crear_tabla_periodica())
